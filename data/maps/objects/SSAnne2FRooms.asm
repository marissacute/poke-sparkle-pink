	object_const_def
	const_export SSANNE2FROOMS_JACINTHE
	...
	const_export SSANNE2FROOMS_WAITER
...
SSAnne2FRooms_Object:
	...
	def_object_events
	object_event 10,  2, SPRITE_BEAUTY, STAY, RIGHT, TEXT_SSANNE2FROOMS_JACINTHE, OPP_JACINTHE, 1
	...
	object_event 10,  3, SPRITE_WAITER, STAY, RIGHT, TEXT_SSANNE2FROOMS_WAITER
