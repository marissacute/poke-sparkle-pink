...
Rival1Data:
    ...
    db 5, IGGLYBUFF, 0
; Route 22
    db $FF, 9, PIDGEY, 8, MAGNEMITE, 0
    db $FF, 9, PIDGEY, 8, DRATINI, 0
    db $FF, 9, PIDGEY, 8, IGGLYBUFF, 0
; Cerulean City
    db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, MAGNEMITE, 0
    db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, DRATINI, 0
    db $FF, 18, PIDGEOTTO, 15, ABRA, 15, RATTATA, 17, IGGLYBUFF, 0

ProfOakData:
; Unused
    db $FF, 76, TAUROS, 78, VENUSAUR, 78, CHARIZARD, 78, BLASTOISE, 80, DRAGONITE, 0
    db $FF, 76, TAUROS, 78, VENUSAUR, 78, CHARIZARD, 78, BLASTOISE, 80, WIGGLYTUFF, 0
    db $FF, 76, TAUROS, 78, VENUSAUR, 78, CHARIZARD, 78, BLASTOISE, 80, MAGNEZONE, 0
...
Rival2Data:
; SS Anne 2F
    db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, KADABRA, 20, MAGNETON, 0
    db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, KADABRA, 20, DRAGONAIR, 0
    db $FF, 19, PIDGEOTTO, 16, RATICATE, 18, KADABRA, 20, JIGGLYPUFF, 0
; Pokémon Tower 2F
    db $FF, 25, PIDGEOTTO, 23, GROWLITHE, 22, EXEGGCUTE, 20, KADABRA, 25, MAGNETON, 0
    db $FF, 25, PIDGEOTTO, 23, GYARADOS, 22, GROWLITHE, 20, KADABRA, 25, DRAGONAIR, 0
    db $FF, 25, PIDGEOTTO, 23, EXEGGCUTE, 22, GYARADOS, 20, KADABRA, 25, JIGGLYPUFF, 0
; Silph Co. 7F
    db $FF, 37, PIDGEOT, 38, GROWLITHE, 35, EXEGGCUTE, 35, ALAKAZAM, 40, MAGNEZONE, 0
    db $FF, 37, PIDGEOT, 38, GYARADOS, 35, GROWLITHE, 35, ALAKAZAM, 40, DRAGONITE, 0
    db $FF, 37, PIDGEOT, 38, EXEGGCUTE, 35, GYARADOS, 35, ALAKAZAM, 40, WIGGLYTUFF, 0
; Route 22
    db $FF, 47, PIDGEOT, 45, RHYHORN, 45, GROWLITHE, 47, EXEGGCUTE, 50, ALAKAZAM, 53, MAGNEZONE, 0
    db $FF, 47, PIDGEOT, 45, RHYHORN, 45, GYARADOS, 47, GROWLITHE, 50, ALAKAZAM, 53, DRAGONITE, 0
    db $FF, 47, PIDGEOT, 45, RHYHORN, 45, EXEGGCUTE, 47, GYARADOS, 50, ALAKAZAM, 53, WIGGLYTUFF, 0

Rival3Data:
    db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, ARCANINE, 63, EXEGGUTOR, 65, MAGNEZONE, 0
    db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, GYARADOS, 63, ARCANINE, 65, DRAGONITE, 0
    db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, EXEGGUTOR, 63, GYARADOS, 65, WIGGLYTUFF, 0
