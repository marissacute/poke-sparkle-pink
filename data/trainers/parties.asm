...
LtSurgeData:
	...
	db $FF, 66, ELECTRODE, 67, ELECTABUZZ, 67, JOLTEON, 67, MAGNEZONE, 68, RAICHU

ErikaData:
	db $FF, 29, VICTREEBEL, 24, TANGELA, 29, VILEPLUME, 0
	db $FF, 68, VICTREEBEL, 69, VILEPLUME, 69, TANGELA, 69, EXEGGUTOR, 70, BELLOSSOM

KogaData:
	db $FF, 37, KOFFING, 40, MUK, 37, KOFFING, 43, WEEZING, 0
	db $FF, 70, MUK, 71, WEEZING, 71, ARBOK, 71, VENOMOTH, 72, CROBAT
