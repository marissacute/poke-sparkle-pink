...
; Characteristics of each move.
	...
	move GUILLOTINE,   NO_ADDITIONAL_EFFECT,        70, BUG,          100, 15 ; increased crit chance
	move RAZOR_WIND,   CHARGE_EFFECT,              150, FLYING,        85, 10
	...
	move DRAGON_SLAM,  NO_ADDITIONAL_EFFECT,        80, DRAGON,       100, 15
	...
	move HORN_DRILL,   NO_ADDITIONAL_EFFECT,        60, GROUND,        95, 20
	...
	move PSYBEAM,      CONFUSION_SIDE_EFFECT_10,    65, PSYCHIC_TYPE, 100, 20
	...
	move STRENGTH,     NO_ADDITIONAL_EFFECT,        60, FIGHTING,     100, 15
	...
	move CONFUSION,    CONFUSION_SIDE_EFFECT_10,    50, PSYCHIC_TYPE, 100, 25
